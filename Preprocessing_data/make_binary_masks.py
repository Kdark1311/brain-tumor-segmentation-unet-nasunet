...
def coco_to_binary_masks(dataset_root="D:\Progamming\Progamming_courses\Python\Segmentation_project\archive", subsets=("train", "valid", "test")):
    for s in subsets:
...
if __name__ == "__main__":
    ...
    coco_to_binary_masks(dataset_root=r"D:\Progamming\Progamming_courses\Python\Segmentation_project\archive",
