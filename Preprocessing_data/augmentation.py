...
# =========================
# 2. Augment và lưu file .npy
# =========================
def process_split(img_dir, mask_dir, output_dir, n_aug=2):
    ...
    idx = 0
    for img_name in tqdm(img_files, desc=f"Processing {os.path.basename(img_dir)}"):
...
if __name__ == "__main__":
    dataset_root = r"D:\Progamming\Progamming_courses\Python\Segmentation_project\archive"
    ...
    for split in ["train", "valid", "test"]:
        ...
        process_split(img_dir, mask_dir, out_split, n_aug=2)
